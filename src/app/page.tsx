  ...
  return (
    <main className="w-full overflow-x-clip">
        ...
        <div className="mx-auto grid w-full max-w-6xl items-center gap-14 px-6 pb-24 pt-16 lg:grid-cols-[1.05fr_0.95fr] lg:pt-24">
          <div className="animate-fade-up">
            ...
            <div className="mt-9 flex flex-wrap items-center gap-3">
              <Link
                href="/evaluacion"
                className="bg-brand-animated group inline-flex items-center gap-2 rounded-full px-8 py-4 text-sm font-bold text-white shadow-2xl shadow-indigo-500/40 transition hover:scale-[1.04] hover:shadow-fuchsia-500/30"
              >
              ...
              <Link
                href="/login"
                className="rounded-full border border-slate-300/80 bg-white/70 px-8 py-4 text-sm font-semibold text-slate-700 backdrop-blur transition hover:border-indigo-300 hover:bg-white hover:text-indigo-700"
              >
          ...
          <div className="animate-fade-up relative hidden lg:block [animation-delay:150ms]">
            ...
            <div
              ...
              style={{
                background:
                  "conic-gradient(from 0deg, #6366f1, #d946ef, #0ea5e9, #10b981, #6366f1)",
              }}
            />

            <div className="animate-float relative -rotate-1 rounded-[1.75rem] border border-white/80 bg-white/95 p-6 shadow-[0_40px_80px_-24px_rgba(79,70,229,0.45)] backdrop-blur">
              <div className="flex items-center justify-between">
                ...
                <div className="flex flex-col items-center gap-1">
                  <span className="bg-brand-animated rounded-2xl px-3.5 py-2 text-base font-black text-white shadow-lg shadow-indigo-500/40">
                    DI
                  </span>
                </div>
              </div>
            ...
            {/* Chip flotante: EQ */}
            <div className="absolute -right-8 -top-8 flex rotate-3 items-center gap-3 rounded-2xl border border-white/80 bg-white/95 px-4 py-3 shadow-xl shadow-indigo-500/15 backdrop-blur">
      ...
      <section className="reveal mx-auto w-full max-w-6xl px-6 py-24">
        <h2 className="text-center text-xs font-bold uppercase tracking-[0.3em] text-indigo-500">
          Cómo funciona
        </h2>
        ...
        <div className="relative mt-16 grid gap-10 md:grid-cols-3 md:gap-6">
          <div
            className="pointer-events-none absolute left-[16%] right-[16%] top-7 hidden border-t-2 border-dashed border-indigo-200 md:block"
            aria-hidden
          />
          {STEPS.map((s) => (
            <div key={s.n} className="relative text-center md:px-4">
              <span className="bg-brand-animated relative z-10 mx-auto flex h-14 w-14 items-center justify-center rounded-2xl text-xl font-black text-white shadow-xl shadow-indigo-500/30">
                {s.n}
              </span>
      ...
      <section className="relative overflow-hidden bg-slate-950 py-24">
        ...
        <div className="relative mx-auto w-full max-w-6xl px-6">
          <h2 className="text-center text-xs font-bold uppercase tracking-[0.3em] text-indigo-400">
            El resultado
          </h2>
          ...
          <div className="mt-16 grid gap-6 lg:grid-cols-2">
            ...
            <div className="reveal group rounded-3xl border border-white/10 bg-white/[0.04] p-8 backdrop-blur transition hover:border-indigo-400/40 hover:bg-white/[0.06]">
              <div className="flex items-center justify-between">
                <h3 className="text-xl font-extrabold tracking-tight text-white">
                  Informe individual
                </h3>
                <span className="rounded-full border border-indigo-400/30 bg-indigo-500/15 px-3 py-1 text-[10px] font-bold uppercase tracking-wide text-indigo-300">
                  8 bloques
                </span>
              </div>
                  ...
                  <div key={b.code} className="flex items-center gap-3">
                    ...
                    <div className="h-2 flex-1 overflow-hidden rounded-full bg-white/10">
                      <div
                        ...
                        style={{ width: `${b.percent}%`, backgroundColor: color(b.code) }}
                      />
                    </div>
                  </div>
                ))}
            ...
            <div className="reveal group rounded-3xl border border-white/10 bg-white/[0.04] p-8 backdrop-blur transition hover:border-fuchsia-400/40 hover:bg-white/[0.06]">
              <div className="flex items-center justify-between">
                <h3 className="text-xl font-extrabold tracking-tight text-white">
                  Mapa de equipo
                </h3>
                <span className="rounded-full border border-fuchsia-400/30 bg-fuchsia-500/15 px-3 py-1 text-[10px] font-bold uppercase tracking-wide text-fuchsia-300">
                  10 pantallas
                </span>
              </div>
              <p className="mt-2 text-sm leading-relaxed text-slate-400">
        ...
        <div className="relative mx-auto w-full max-w-6xl px-6 py-24">
          ...
          <div className="mt-14 grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
            {FEATURES.map((f) => (
              <div
                key={f.title}
                className="group rounded-3xl border border-slate-200/80 bg-white/90 p-7 backdrop-blur transition duration-300 hover:-translate-y-1.5 hover:border-indigo-200 hover:shadow-2xl hover:shadow-indigo-200/50"
              >
                <span className="bg-brand-animated flex h-11 w-11 items-center justify-center rounded-2xl text-lg text-white shadow-lg shadow-indigo-500/30 transition duration-300 group-hover:scale-110 group-hover:rotate-6">
                  {f.icon}
                </span>
      ...
      <section className="reveal mx-auto w-full max-w-4xl px-6 pb-8">
        <div className="relative overflow-hidden rounded-3xl border border-indigo-100 bg-white/80 p-9 text-center backdrop-blur">
      ...
      <section className="reveal mx-auto w-full max-w-6xl px-6 py-20">
        <div className="bg-brand-animated relative overflow-hidden rounded-[2.75rem] px-8 py-16 text-center text-white shadow-2xl shadow-indigo-500/40">
          <div
            className="pointer-events-none absolute -left-16 -top-24 h-72 w-72 rounded-full bg-white/15 blur-3xl"
            aria-hidden
          />
          <div
            className="pointer-events-none absolute -bottom-28 -right-12 h-80 w-80 rounded-full bg-fuchsia-300/25 blur-3xl"
            aria-hidden
          />
          ...
          <div className="relative mt-9 flex flex-wrap items-center justify-center gap-3">
            <Link
              href="/evaluacion"
              className="rounded-full bg-white px-9 py-4 text-sm font-black text-indigo-700 shadow-2xl transition hover:scale-[1.05]"
            >
              Comenzar evaluación →
            </Link>
            <Link
          ...
          <div className="flex flex-wrap items-start justify-between gap-8">
            <div className="max-w-xs">
              <div className="flex items-center gap-2.5">
                <span className="bg-brand flex h-8 w-8 items-center justify-center rounded-xl text-sm font-black text-white shadow-lg shadow-indigo-500/25">
                  G
                </span>
            ...
            <nav className="flex gap-14 text-sm">
              <div>
                ...
                <ul className="mt-3 space-y-2 text-[13px] font-medium text-slate-600">
                  <li>
                    <Link href="/evaluacion" className="transition hover:text-indigo-600">
                      Evaluación
                    </Link>
                  </li>
                  <li>
                    <a href="#dimensiones" className="transition hover:text-indigo-600">
                      El modelo
                    </a>
                  </li>
                </ul>
              ...
              <div>
                ...
                <ul className="mt-3 space-y-2 text-[13px] font-medium text-slate-600">
                  ...
                  <li>
                    <Link href="/facilitador" className="transition hover:text-indigo-600">
                      Facilitadores
                    </Link>
                  </li>
                </ul>
