...
const es = {
  ...
  report: {
    ...
    situacion: "Situación",
    heatLegend: "Uso del recurso en esa situación",
    heatLow: "Menos",
    heatHigh: "Más",
    indexJump: "Índice",
  ...
  auth: {
    ...
    loginSubtitle: "Accede a tu panel de DISC GESEM.",
    ...
    participantHint:
      "¿Eres participante? Usa el correo y la contraseña que te enviamos en el email de invitación.",
    ...
    recoverSent:
      "Si el correo tiene una cuenta, te hemos enviado un enlace para restablecer tu contraseña. Revisa tu bandeja de entrada.",
    backToLogin: "← Volver al acceso",
    setTitle: "Crea tu contraseña",
    setSubtitle: "Elige una contraseña para acceder a tu cuenta.",
    invalidLinkTitle: "Enlace no válido",
    invalidLinkSubtitle: "Este enlace no existe o ha caducado.",
    ...
    deniedBody: "No tienes permisos para ver esta sección con tu rol actual.",
    deniedBack: "Volver al inicio",
    errCheckCredentials: "Revisa el correo y la contraseña.",
    errWrongCredentials: "Credenciales incorrectas.",
    ...
    errLinkInvalid: "El enlace no es válido o ha caducado. Solicita uno nuevo.",
    errCheckData: "Revisa los datos.",
    errNameShort: "El nombre es demasiado corto.",
    errAdminDelete: "Las cuentas de administrador no se pueden eliminar aquí.",
    errConfirmDelete: "Escribe ELIMINAR para confirmar.",
  },
  reportPage: {
    back: "← Volver",
    ...
    sending: "Enviando…",
    sentTo: (email: string) => `Informe enviado a ${email}.`,
    emailLangNote: "El correo del informe se envía en castellano.",
    notCompleted:
      "Esta persona aún no ha completado la evaluación, por lo que no hay informe disponible.",
  },
  token: {
  ...
  panel: {
    ...
    distributionHint: "Peso relativo de cada recurso en tu estilo.",
...
const ca: typeof es = {
  ...
  report: {
    ...
    situacion: "Situació",
    heatLegend: "Ús del recurs en aquella situació",
    heatLow: "Menys",
    heatHigh: "Més",
    indexJump: "Índex",
  ...
  auth: {
    loginTitle: "Et donem la benvinguda",
    loginSubtitle: "Accedeix al teu panell de DISC GESEM.",
    email: "Correu electrònic",
    emailPh: "tu@empresa.com",
    ...
    participantHint:
      "Ets participant? Fes servir el correu i la contrasenya que et vam enviar al correu d'invitació.",
    resetOk: "Contrasenya actualitzada. Ja pots iniciar sessió.",
    recoverTitle: "Recuperar la contrasenya",
    recoverSubtitle: "T'enviarem un enllaç per crear-ne una de nova.",
    recoverSubmit: "Enviar l'enllaç",
    recoverSending: "Enviant…",
    recoverSent:
      "Si el correu té un compte, t'hem enviat un enllaç per restablir la contrasenya. Revisa la safata d'entrada.",
    backToLogin: "← Tornar a l'accés",
    setTitle: "Crea la teva contrasenya",
    setSubtitle: "Tria una contrasenya per accedir al teu compte.",
    invalidLinkTitle: "Enllaç no vàlid",
    invalidLinkSubtitle: "Aquest enllaç no existeix o ha caducat.",
    newPassword: "Nova contrasenya",
    newPasswordPh: "Mínim 8 caràcters",
    repeatPassword: "Repeteix la contrasenya",
    savePassword: "Desar la contrasenya",
    saving: "Desant…",
    goToLogin: "Anar a l'accés",
    deniedTitle: "Accés denegat",
    deniedBody: "No tens permisos per veure aquesta secció amb el teu rol actual.",
    deniedBack: "Tornar a l'inici",
    errCheckCredentials: "Revisa el correu i la contrasenya.",
    errWrongCredentials: "Credencials incorrectes.",
    errInvalidEmail: "Introdueix un correu vàlid.",
    errPasswordMin: "La contrasenya ha de tenir almenys 8 caràcters.",
    errPasswordsMismatch: "Les contrasenyes no coincideixen.",
    errLinkInvalid: "L'enllaç no és vàlid o ha caducat. Demana'n un de nou.",
    errCheckData: "Revisa les dades.",
    errNameShort: "El nom és massa curt.",
    errAdminDelete: "Els comptes d'administrador no es poden eliminar aquí.",
    errConfirmDelete: "Escriu ELIMINAR per confirmar.",
  },
  reportPage: {
    back: "← Tornar",
    ...
    sending: "Enviant…",
    sentTo: (email: string) => `Informe enviat a ${email}.`,
    emailLangNote: "El correu de l'informe s'envia en castellà.",
    notCompleted:
      "Aquesta persona encara no ha completat l'avaluació, per això no hi ha cap informe disponible.",
  },
  token: {
  ...
  panel: {
    ...
    distributionHint: "Pes relatiu de cada recurs en el teu estil.",
