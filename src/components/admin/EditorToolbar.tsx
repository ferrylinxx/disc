...
/**
 * Barra de formato compartida por el mensaje de bienvenida y el nombre del
 * programa del correo de invitación, para que ambos se editen igual.
 */
...
export const Sep = () => <span className="mx-1 h-5 w-px bg-slate-200" aria-hidden />;
const selectCls =
...
/**
 * Barra de formato de los editores del correo. "full" para el mensaje de
 * bienvenida; "inline" para campos de una línea (nombre del programa): sin
 * tipo de párrafo, alineación, listas, destacado, separador ni enlaces.
 */
export function EditorToolbar({ editor, variant = "full" }: { editor: Editor; variant?: "full" | "inline" }) {
  ...
  return (
    <div ref={barRef} className="relative flex flex-wrap items-center gap-0.5 border-b border-slate-200 bg-slate-50/80 px-1.5 py-1">
      ...
      <select
        ...
        title="Tipografía (con Ctrl+A la aplicas a todo el texto)"
